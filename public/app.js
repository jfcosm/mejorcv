document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      diagnosticCtaHeadshotsSubtitle: "Genera 20 retratos fotográficos de alta resolución con iluminación de estudio profesional y estilos corporativos.",
      ...
      previewSectionSubtitle: "Reescritura completa ATS y guía de consultoría personalizada con palabras clave estratégicas y fórmulas de logros.",
      unlockCtaHeading: "Desbloquea tu Currículum Optimizado y Plan de Acción",
      unlockCtaDescription: "Descarga tu CV reescrito por Cintia para filtros ATS junto con la guía de palabras clave estratégicas y redacción de logros.",
      unlockCtaPeriod: "USD / pago único",
      unlockActionBtnText: "Desbloquear y Descargar Currículum",
      ...
      pricingSubtitle: "Trabaja 1 a 1 con un especialista en RRHH y Reclutamiento para potenciar tu perfil y preparar tus próximas entrevistas.",
      aiPlanName: "Optimización por IA",
      aiPlanPriceUnit: "USD / pago único",
      aiPlanF1: "Reescritura inmediata por Cintia",
      aiPlanF2: "Inyección de palabras clave ATS",
      aiPlanF3: "Reorganización de habilidades y perfil",
      aiPlanF4: "Descarga instantánea en texto/markdown",
      aiPlanBtn: "Optimizar con IA",
      expertPlanName: "Asesoría 1 a 1 y Optimización por Experto",
      expertPlanPriceUnit: "USD / sesión y entrega final",
      expertEmailLabel: "Correo Electrónico",
      expertEmailPlaceholder: "nombre@correo.com",
      expertPhoneLabel: "Celular o WhatsApp",
      expertContactHint: "* Ambos datos de contacto son obligatorios para garantizar la coordinación de tu sesión.",
      expertPlanF1: "Optimización del CV por un experto humano en RRHH y reclutamiento.",
      expertPlanF2: "Sesión de Asesoría: 1.5 horas de acompañamiento, entrega de feedback y entrevista personalizada.",
      expertPlanF3: "Entrega del CV optimizado en formatos PDF y Word editable.",
      expertPlanBtn: "Solicitar Asesoría con Experto ($25 USD)",
      ...
      heroPill4: "20 Fotos de Estudio (IA)",
      heroPill5: "Mentoría 1 a 1 Experto",
      coachShowcaseBadge: "CAPACIDADES DE CINTIA.PRO",
      coachShowcaseTitle: "El Ecosistema Completo para tu Éxito Laboral",
      coachShowcaseSubtitle: "Cintia combina inteligencia artificial de vanguardia y experiencia humana en reclutamiento para acompañarte estratégicamente en cada fase de tu postulación.",
      ...
      coachCardDescHeadshots: "Sube tu foto base y genera 20 retratos fotográficos de alta resolución con iluminación de estudio profesional, vestimentas ejecutivas y fondos modernos.",
      ...
      jobOfferLabel: "Texto o requisitos de la oferta de trabajo:",
      jobOfferPlaceholder: "Ejemplo: 'Buscamos un Ingeniero de Software con experiencia en Node.js y React para liderar el desarrollo de APIs escalables...'",
    ...
    en: {
      ...
      heroPill4: "20 Studio Headshots (AI)",
      heroPill5: "1-on-1 Human Mentoring",
      coachShowcaseBadge: "CINTIA.PRO CAPABILITIES",
      coachShowcaseTitle: "Everything You Need to Land Your Next Job",
      coachShowcaseSubtitle: "Cintia pairs state-of-the-art artificial intelligence with recruitment expertise to strategically guide every phase of your job search.",
  ...
  function applyLanguage(lang) {
    ...
    for (let p = 1; p <= 4; p++) {
      ...
      if (pillEl && t[`heroPill${p}`]) pillEl.textContent = t[`heroPill${p}`];
    }
    ...
    // Coach Showcase Section dynamic translations
    const coachBadgeEl = document.getElementById('coachShowcaseBadge');
    if (coachBadgeEl) coachBadgeEl.textContent = t.coachShowcaseBadge;
    const coachTitleEl = document.getElementById('coachShowcaseTitle');
    if (coachTitleEl) coachTitleEl.textContent = t.coachShowcaseTitle;
    ...
    for (let c = 1; c <= 3; c++) {
      ...
      if (titleEl && t[`coachCardTitle${c}`]) titleEl.textContent = t[`coachCardTitle${c}`];
    ...
    for (let s = 1; s <= 4; s++) {
      const sTitle = document.getElementById(`step${s}Title`);
      if (sTitle && t[`step${s}Title`]) sTitle.textContent = t[`step${s}Title`];
      const sDesc = document.getElementById(`step${s}Desc`);
      if (sDesc && t[`step${s}Desc`]) sDesc.textContent = t[`step${s}Desc`];
    }
    ...
    try {
      ...
      if (loadingStepText) {
        const steps = currentLanguage === 'en'
          ? [
              "Analyzing facial traits and composing professional studio portraits...",
          ...
          : [
              "Analizando rasgos faciales y componiendo retratos de estudio profesional...",
