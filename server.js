...
app.get('/api/config', async (req, res) => {
  ...
  res.json({
    ...
    quickTestBtnEnabled: config.hasOwnProperty('quickTestBtnEnabled') ? !!config.quickTestBtnEnabled : true,
...
app.post('/api/admin/settings', requireAdminAuth, async (req, res) => {
  try {
    ...
    if (newSettings.hasOwnProperty('quickTestBtnEnabled')) config.quickTestBtnEnabled = !!newSettings.quickTestBtnEnabled;
